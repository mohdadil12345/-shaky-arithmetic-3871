...
[
    ...
    },
    {
        ...
        "img": "https://d2bps9p1kiy4ka.cloudfront.net/5eb393ee95fab7468a79d189/cf488179-88b5-41d5-86e4-782eac9bf70d.png",
    ...
    {
        "name": "Complete Science Course (English) 2023",
        "duration": "31 Dec 2023  -  Dec 2024",
        "lectureType": "Live Lectures",
        "otherDetails": [
        ...
        "img": "https://d2bps9p1kiy4ka.cloudfront.net/5eb393ee95fab7468a79d189/5f67b97b-b858-45d5-9fdd-afd04ef21ec9.png",
  ...
  function dataextract(arr) {
    let data = []

    arr.forEach(e => {
        e.subject.forEach(element => {
...
//   console.log(abcd(dataextract(arr)))
//   function abcd(arr) {
//     for (let i = 0; i < arr.length; i++) {
//         arr[i] = {name: arr[i] , icon:""}
...
function chatfun(course_id , student) {
